...
@Component({
  selector: 'enter-polygon-sides-number-dialog',
  template: `
  <h1 mat-dialog-title> Enter Polygon Sides Number </h1>
...
export class EnterPolygonSidesNumberDialogComponent {
  form: FormGroup

  constructor(
    public dialogRef: MatDialogRef<EnterPolygonSidesNumberDialogComponent>,
